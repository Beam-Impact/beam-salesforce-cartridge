...
function getApproachingDiscounts(basket, discountPlan) {
    ...
    if (basket && basket.productLineItems) {
        ...
        approachingShippingDiscounts =
            discountPlan.getApproachingShippingDiscounts(
...
function CartModel(basket) {
    ...
    if (basket !== null) {
        ...
        this.beamCart = {
            ...
            itemCount: productLineItemsModel.totalQuantity,
            content: {
                items:
                    basket.productLineItems &&
        ...
        if (shippingModels) {
            this.shipments = shippingModels.map(function (shippingModel) {
                ...
                result.shippingMethods =
                    shippingModel.applicableShippingMethods;
        ...
        if (discountPlan) {
            this.approachingDiscounts = getApproachingDiscounts(
                basket,
                discountPlan
            );
        }
