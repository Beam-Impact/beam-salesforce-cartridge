...
function getAssociatedAddress(basket, customer) {
    ...
    if (
        ...
        for (
            var j = 0, jj = customer.addressBook.addresses.length;
            j < jj;
            j++
        ) {
...
function OrderModel(lineItemContainer, options) {
    ...
    if (!lineItemContainer) {
        ...
        var usingMultiShipping =
            safeOptions.usingMultiShipping ||
        ...
        var associatedAddress = getAssociatedAddress(
            lineItemContainer,
            customer
        );
        ...
        this.currencyCode = lineItemContainer.currencyCode; // currencyCode addition for post-purchase widget
