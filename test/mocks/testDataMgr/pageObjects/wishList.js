...
function createCssNthWishListRow(idx) {
...
export function getDesiredQuantityByRow(rowNum) {
    var selector = [createCssNthWishListRow(rowNum), '.form-row.option-quantity-desired input[name$=dwfrm_wishlist_items_i0_quantity'].join(' ');
